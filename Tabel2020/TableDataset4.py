...
st.markdown("<h2 style='text-align: center;'> Jumlah Penduduk menurut Wilayah, Klasifikasi Generasi, dan Jenis Kelamin, INDONESIA, Tahun 2020</h2>", unsafe_allow_html=True)
st.write("\n\n")
