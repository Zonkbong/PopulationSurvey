...
st.markdown("<h2 style='text-align: center;'>Jumlah Penduduk Menurut Wilayah, Kesesuaian Alamat KK dengan Domisili, dan Jenis Kelamin Tahun 2020</h2>", unsafe_allow_html=True)
st.write("\n\n")
